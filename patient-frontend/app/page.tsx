        ...
        <main>
            <div className="flex justify-center items-center w-full h-screen md:pb-30">
                <div className="rounded-lg border-gray-300 backdrop-blur-lg">
                    <form>
                        <motion.h1 initial={{ scale: 0, y: 20 }} animate={{
                            scale: 1, transition: {
                                opacity: { ease: "linear" }
                            }, y: -25
                        ...
                        <motion.p initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 1 }} className="text-xl">
                            Start your preliminary examination with a few simple questions
                        </motion.p>
                        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 2 }} className="text-center mt-10">
                            <motion.div
