...
class TokensServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                request_serializer=ml__pb2.HelloRequest.SerializeToString,
                response_deserializer=ml__pb2.Hello.FromString,
                _registered_method=True)


class TokensServerServicer(object):
    """Missing associated documentation comment in .proto file."""

    def FindSymptoms(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_TokensServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=ml__pb2.HelloRequest.FromString,
                    response_serializer=ml__pb2.Hello.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'TokensServer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('TokensServer', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class TokensServer(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def FindSymptoms(request,
            target,
            options=(),
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/TokensServer/SayHello',
            ml__pb2.HelloRequest.SerializeToString,
            ml__pb2.Hello.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
